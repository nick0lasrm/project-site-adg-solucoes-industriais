...
<head>
    <meta charset="UTF-8">
    <base href="http://localhost/adg-v2/">
...
<body>
    ...
    <!-- Header Navbar -->
    <header class="position-sticky bg-black z-3 top-0">
        <div class="">
            ...
            <ul class="m-0 p-0 d-none d-md-inline-flex gap-4 list-unstyled">
                <li>
                    <a class="nav_link fw-bold fs-5 text-decoration-none c-red text-uppercase"
                        aria-label="Botão que leva para o início" href="index.php">
                        Início
                    </a>
                </li>
                <li>
                    <a class="nav_link fw-bold fs-5 text-decoration-none c-red text-uppercase"
                        aria-label="Botão que leva para a seção serviços" href="pages/servicos.php">
                        Serviços
                    </a>
                </li>
                <li id="dropmenu">
                    <a class="nav_link fw-bold fs-5 text-decoration-none c-red d-inline-flex align-items-center gap-2 text-uppercase"
                        aria-label="Botão que leva para a seção serviços" href="pages/produtos/index.php">
                        Produtos
                    ...
                    <ul id="menu-items"
                        class="menu-items m-0 p-0 list-unstyled position-absolute rounded-bottom bg-black text-nowrap">
                        <li class="py-3 px-4">
                            <a class="fw-bold fs-6 text-decoration-none c-red text-uppercase"
                                href="pages/produtos/index.php#ceramicas">
                                Cerâmicas
                            </a>
                        </li>
                        <li class="py-3 px-4">
                            <a class="fw-bold fs-6 text-decoration-none c-red text-uppercase"
                                href="pages/produtos/index.php#bicosdecorte">
                                Bicos
                                de Corte
                            </a>
                        </li>
                        <li class="py-3 px-4">
                            <a class="fw-bold fs-6 text-decoration-none c-red text-uppercase"
                                href="pages/produtos/index.php#lentesprotetores">
                                Lentes / Protetores
                            </a>
                        </li>
                        <li class="py-3 px-4">
                            <a class="fw-bold fs-6 text-decoration-none c-red text-uppercase" href="pages/produtos/index.php#filtros">
                                Filtros
                            </a>
                        </li>
                        <li class="py-3 px-4">
                            <a class="fw-bold fs-6 text-decoration-none c-red text-uppercase"
                                href="pages/produtos/index.php#limpeza">
                                Limpeza
                            </a>
                        </li>
                        <li class="py-3 px-4">
                            <a class="fw-bold fs-6 text-decoration-none c-red text-uppercase"
                                href="pages/produtos/index.php#pecasecabecote">
                                Peças
                                e Cabeçotes
                            </a>
                        </li>
                        <li class="py-3 px-4">
                            <a class="fw-bold fs-6 text-decoration-none c-red text-uppercase"
                                href="pages/produtos/index.php#sensores">
                                Sensores
                            </a>
                        </li>
                        <li class="py-3 px-4">
                            <a class="fw-bold fs-6 text-decoration-none c-red text-uppercase"
                                href="pages/produtos/index.php#diversos">
                                Diversos
                            </a>
                        </li>
                    </ul>
                ...
                <li>
                    <a class="nav_link fw-bold fs-5 text-decoration-none c-red text-uppercase"
                        aria-label="Botão que leva para a seção sobre nós" href="pages/quem-somos.php">
                        Sobre
                    </a>
                </li>
                <li>
            ...
            <ul class="m-0 p-0 d-flex flex-column list-unstyled gap-4 px-3">
                ...
                <li id="dropmenu-mobile">
                    <button
                        ...
                        aria-label="Botão que leva para a seção serviços" href="produtos/index.php">
                        Produtos
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <ul id="menu-items-mobile" class="menu-items-mobile m-0 list-unstyled position-inherit bg-grey">
                        ...
                        <li class="p-3">
                            <a class="fw-bold fs-6 text-decoration-none c-red text-uppercase"
                                href="pages/produtos/index.php#filtros">
                                Filtros
                            </a>
                        </li>
                        <li class="p-3">
